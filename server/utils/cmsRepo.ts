...
const categories: Category[] = [
  { id: 1, name: "Monitoreo", description: "Sistemas de monitoreo y sensores" },
  {
    id: 2,
    name: "Análisis",
    description: "Servicios de análisis de suelo y cultivos",
  },
  {
    id: 3,
    name: "Consultoría",
    description: "Servicios de consultoría agrícola",
  },
  {
    id: 4,
    name: "Tecnología",
    description: "Tecnología avanzada para agricultura",
  },
  { id: 5, name: "Software", description: "Soluciones de software agrícola" },
  {
    id: 6,
    name: "Alimentación Animal",
    description: "Productos para alimentación animal",
  },
...
const products: ProductRecord[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Concentrado para desarrollo de becerros en etapa de crecimiento.",
    price: 2600,
    currency: "MXN",
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    shortDescription:
      "Alimento completo peletizado para cervatos en etapas Starter y Grower.",
    price: 3000,
    currency: "MXN",
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    shortDescription:
      "Suplemento a libre acceso para ganado bovino en pastoreo",
    price: 3000,
    currency: "MXN",
    inStock: true,
    featured: true,
...
const productPictures: ProductPicture[] = [
  {
    id: 1,
    productId: 1,
    imageUrl: "/assets/img/products/monitoring-system.svg",
    displayOrder: 0,
  },
  {
    id: 2,
  ...
  },
  {
    id: 7,
    productId: 3,
    imageUrl: "/assets/img/products/product-box.svg",
    displayOrder: 0,
  },
  {
    id: 8,
...
const productFeatures: ProductFeature[] = [
  { id: 1, productId: 1, featureText: "Presentación 40 kg", displayOrder: 0 },
  {
    id: 2,
    productId: 1,
    featureText: "Alta biodisponibilidad de minerales",
    displayOrder: 1,
  },
  {
    id: 3,
    productId: 1,
    featureText: "Incluye levaduras vivas",
    displayOrder: 2,
  },
  {
    id: 4,
    productId: 1,
    featureText: "Modificadores de fermentación ruminal",
    displayOrder: 3,
  },
  {
    id: 5,
    productId: 1,
    featureText: "Aporte balanceado de proteína y energía",
    displayOrder: 4,
  },
  {
    id: 6,
    productId: 1,
    featureText: "Estimula desarrollo de rumen",
    displayOrder: 5,
  },
  {
    id: 7,
    productId: 1,
    featureText: "Ayuda a destete más temprano",
    displayOrder: 6,
  },
  {
    id: 8,
    productId: 1,
    featureText: "Mejora la ganancia de peso",
    displayOrder: 7,
  },
  { id: 9, productId: 1, featureText: "Alta palatabilidad", displayOrder: 8 },
  {
    id: 10,
    productId: 1,
    featureText: "Tecnología CitriStim, Xtract, Alkosel",
    displayOrder: 9,
  },
  { id: 11, productId: 2, featureText: "Presentación 40 kg", displayOrder: 0 },
  {
    id: 12,
    productId: 2,
    featureText: "Alto contenido energético",
    displayOrder: 1,
  },
  {
    id: 13,
    productId: 2,
    featureText: "Balance ideal de proteínas degradables",
    displayOrder: 2,
  },
  {
    id: 14,
    productId: 2,
    featureText: "Tecnología CitriStim, Aminosoy, d-alpha",
    displayOrder: 3,
  },
  {
    id: 15,
    productId: 2,
    featureText: "Vitaminas y minerales de alta biodisponibilidad",
    displayOrder: 4,
  },
  {
    id: 16,
    productId: 2,
    featureText: "Mejora la conversión alimenticia",
    displayOrder: 5,
  },
  {
    id: 17,
    productId: 2,
    featureText: "Estimula el crecimiento",
    displayOrder: 6,
  },
  {
    id: 18,
    productId: 2,
    featureText: "Fortalece el sistema inmunológico",
    displayOrder: 7,
  },
  {
    id: 19,
    productId: 3,
    featureText: "Producto de alta calidad",
    displayOrder: 0,
  },
  {
    id: 20,
    productId: 3,
    featureText: "Formulado científicamente",
    displayOrder: 1,
  },
  {
    id: 21,
    productId: 3,
    featureText: "Rico en vitaminas y minerales",
    displayOrder: 2,
  },
  {
    id: 22,
...
const productSpecifications: ProductSpecification[] = [
  {
    id: 1,
    productId: 1,
    specName: "Materia seca",
    specValue: "88%",
    createdAt: "2025-07-04 05:04:17",
  },
  {
    id: 2,
    productId: 1,
    specName: "Proteína cruda",
    specValue: "20%",
    createdAt: "2025-07-04 05:04:17",
  },
  {
  ...
  },
  {
    id: 7,
    productId: 1,
    specName: "Presentación",
    specValue: "Saco de 40 kg",
    createdAt: "2025-07-04 05:04:17",
  },
  {
    id: 8,
    productId: 1,
    specName: "Tecnologías",
    specValue: "CitriStim, Xtract, Alkosel, d-alpha",
    createdAt: "2025-07-04 05:04:17",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    specName: "Presentación",
    specValue: "Saco de 40 kg",
    createdAt: "2025-07-04 05:04:22",
  },
  {
    id: 18,
    productId: 3,
    specName: "Conservación",
    specValue: "Lugar fresco y seco",
    createdAt: "2025-07-04 05:04:22",
  },
  {
    id: 19,
...
const productTechnicalSpecs: ProductTechnicalSpec[] = [
  {
    id: 1,
    productId: 1,
    specName: "etapa de consumo",
    specValue: "A partir de los 4 días de edad",
    createdAt: "2025-07-04 05:04:24",
  },
  {
    id: 2,
    productId: 1,
  ...
  },
  {
    ...
    productId: 2,
    specName: "etapa de consumo",
    specValue: "Becerros de 3-18 meses",
    createdAt: "2025-07-04 05:04:24",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    productId: 2,
    specName: "especie objetivo",
    specValue: "Becerros en crecimiento",
    createdAt: "2025-07-04 05:04:24",
  },
];
...
const productSeoKeywords: ProductSeoKeyword[] = [
  {
    id: 1,
    productId: 1,
    keyword: "alimento iniciador becerras",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 2,
    productId: 1,
    keyword: "concentrado becerras",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    productId: 1,
    keyword: "destete temprano",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 5,
    productId: 1,
    keyword: "desarrollo rumen",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 6,
    productId: 1,
    keyword: "ganancia peso becerras",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 7,
    productId: 1,
    keyword: "alimentación becerras",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 8,
    productId: 1,
    keyword: "vitaminas minerales becerras",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 9,
    productId: 1,
    keyword: "levaduras vivas",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 10,
    productId: 1,
    keyword: "citristim xtract",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 11,
    productId: 1,
    keyword: "peletizado becerras",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 12,
  ...
  },
  {
    id: 13,
    productId: 1,
    keyword: "becerras lecheras",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 14,
    productId: 1,
    keyword: "iniciador premium",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 15,
    productId: 1,
    keyword: "minerales orgánicos",
    createdAt: "2025-07-04 05:04:29",
  },
  {
    id: 16,
    productId: 2,
    keyword: "concentrado desarrollo becerros",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 17,
    productId: 2,
  ...
  },
  {
    id: 18,
    productId: 2,
    keyword: "dhp concentrado",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 19,
    productId: 2,
    keyword: "crecimiento bovinos",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 20,
    productId: 2,
    keyword: "alimentación becerros",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 21,
    productId: 2,
    keyword: "proteínas degradables",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 22,
    productId: 2,
    keyword: "vitaminas minerales",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 23,
    productId: 2,
    keyword: "potencial genético",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 24,
    productId: 2,
    keyword: "forrajes calidad",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 25,
    productId: 2,
    keyword: "desarrollo becerros",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 26,
    productId: 2,
    keyword: "nutrición bovina",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 27,
    productId: 2,
    keyword: "concentrado premium",
    createdAt: "2025-07-04 05:04:32",
  },
  {
    id: 28,
    productId: 3,
    keyword: "alimentación animal",
    createdAt: "2025-07-04 05:04:35",
  },
  {
    id: 29,
    productId: 3,
  ...
  },
  {
    id: 51,
    productId: 10,
    keyword: "DESARROLLO HIGH PERFORMANCE",
    createdAt: "2025-07-04 05:04:35",
  },
  {
    id: 52,
...
const maxId = (items: { id: number }[]) =>
  items.length ? Math.max(...items.map((item) => item.id)) : 0;
...
const buildProduct = (record: ProductRecord): Product => {
  ...
  return {
    ...
    technicalSpecs: productTechnicalSpecs.filter(
      (item) => item.productId === record.id,
    ),
    relatedProductIds: productRelated
      .filter((item) => item.productId === record.id)
      .map((item) => item.relatedProductId),
    seoKeywords: productSeoKeywords
      .filter((item) => item.productId === record.id)
...
export const deleteCategory = (id: number) => {
  ...
  for (let i = productCategories.length - 1; i >= 0; i -= 1) {
    const relation = productCategories[i];
...
export const updateLabel = (id: number, payload: Partial<Label>): Label => {
  ...
  if (payload.description !== undefined)
    label.description = payload.description.trim();
  return label;
};
...
export const deleteLabel = (id: number) => {
  ...
  for (let i = productLabels.length - 1; i >= 0; i -= 1) {
    const relation = productLabels[i];
    if (!relation) continue;
    if (relation.labelId === id) {
...
export const listProducts = (filters?: {
  ...
  if (filters?.categoryId) {
    result = result.filter((product) =>
      productCategories.some(
        (pc) =>
          pc.productId === product.id && pc.categoryId === filters.categoryId,
      ),
    );
  }
  ...
  if (filters?.labelId) {
    result = result.filter((product) =>
      productLabels.some(
        (pl) => pl.productId === product.id && pl.labelId === filters.labelId,
      ),
    );
  }
...
export const updateProduct = (
  ...
  const sanitized = payload.name
    ? sanitizeProductInput({ ...product, ...payload })
    : { ...product, ...payload };
  ...
  if (payload.categoryIds) {
    for (let i = productCategories.length - 1; i >= 0; i -= 1) {
      const relation = productCategories[i];
      if (!relation) continue;
      if (relation.productId === id) productCategories.splice(i, 1);
    }
  ...
  if (payload.labelIds) {
    for (let i = productLabels.length - 1; i >= 0; i -= 1) {
      const relation = productLabels[i];
      if (!relation) continue;
      if (relation.productId === id) productLabels.splice(i, 1);
    }
...
export const deleteProduct = (id: number) => {
  ...
  for (let i = productPictures.length - 1; i >= 0; i -= 1) {
    const relation = productPictures[i];
    if (!relation) continue;
    if (relation.productId === id) productPictures.splice(i, 1);
  }
  for (let i = productFeatures.length - 1; i >= 0; i -= 1) {
    const relation = productFeatures[i];
    if (!relation) continue;
    if (relation.productId === id) productFeatures.splice(i, 1);
  }
  for (let i = productSpecifications.length - 1; i >= 0; i -= 1) {
    const relation = productSpecifications[i];
    if (!relation) continue;
    if (relation.productId === id) productSpecifications.splice(i, 1);
  }
  for (let i = productTechnicalSpecs.length - 1; i >= 0; i -= 1) {
    const relation = productTechnicalSpecs[i];
    if (!relation) continue;
    if (relation.productId === id) productTechnicalSpecs.splice(i, 1);
  }
  for (let i = productRelated.length - 1; i >= 0; i -= 1) {
    const relation = productRelated[i];
    if (!relation) continue;
    if (relation.productId === id || relation.relatedProductId === id)
      productRelated.splice(i, 1);
  }
  for (let i = productSeoKeywords.length - 1; i >= 0; i -= 1) {
    const relation = productSeoKeywords[i];
    if (!relation) continue;
    if (relation.productId === id) productSeoKeywords.splice(i, 1);
  }
};
